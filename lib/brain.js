...
module.exports = function(bot, config) {
    ...
    */
    ...
    Brain.train = function(request, response) {
        console.log(response);
        classifier.addDocument(request, response);
        Brain.store.push(request);
        classifier.train();
    }

    Brain.respond = function(request) {
        if(Brain.store.contains(request)) {
